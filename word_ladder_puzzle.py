...
class WordLadderPuzzle(Puzzle):
    ...
    def __eq__(self, other: WordLadderPuzzle) -> bool:
        ...
        True
        """
        same_from_words = self.from_word == other.from_word
        same_to_words = self.to_word == other.to_word
        same_word_sets = self.word_set == other.word_set
        return same_word_sets and same_to_words and same_from_words
